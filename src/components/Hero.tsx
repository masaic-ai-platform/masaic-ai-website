    ...
    <section className="pt-32 pb-16 relative overflow-hidden">
      ...
      <div className="flex justify-center mt-[-15px] mb-10">
        <div className="flex overflow-hidden rounded-full shadow-sm">
          <div className="flex items-center h-9 bg-mosaic-primary px-5 text-white text-xs font-semibold">
            New Launch
          </div>
          <div className="flex items-center h-9 bg-white px-5 text-sm font-medium border-y border-r border-gray-200">
            OpenResponses API
          </div>
          <a href="https://github.com/masaic-ai-platform/open-responses" 
             target="_blank" 
             rel="noopener noreferrer"
             className="flex items-center h-9 bg-white px-4 border-y border-r border-gray-200 gap-2 hover:bg-gray-50 transition-colors">
